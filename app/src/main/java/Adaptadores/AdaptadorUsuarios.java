...
import uteq.solutions.contenedores1.R;

public class AdaptadorUsuarios
        extends ArrayAdapter<Usuario> {

    public AdaptadorUsuarios(Context context, ArrayList<Usuario>  datos) {
        super(context, R.layout.lyitemusr, datos);
    }

    public View getView(int position, View convertView, ViewGroup parent) {

        LayoutInflater inflater = LayoutInflater.from(getContext());
        View item = inflater.inflate(R.layout.lyitemusr, null);
        ...
        TextView lbblWeb = (TextView)item.findViewById(R.id.lblweb);
        lbblWeb.setText(getItem(position).getWebsite());
